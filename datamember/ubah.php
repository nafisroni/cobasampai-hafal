<?php 
  ...
  $id = $_GET["id"];
  // query data warnet
  $lgn = query("SELECT * FROM data_member WHERE id = $id")[0];
    ...
    <div class="container px-5 my-5">
          ...
          <table class="table table-warning table-hover" cellpadding="10" cellspacing="0">
                    <tr>
                        ...
                        <td width="30px">:</td>
                        <td><input type="text" name="username" id="username" required value="<?= $lgn["username"];?>" /></td>
                    </tr>
                    <tr>  
                        <td>Jenis billing</td>
                        <td>:</td>
                        <td><input type="text" name="jenisbilling" id="jenisbilling"required value="<?= $lgn["jenisbilling"];?>" /></td>
                    </tr>
                    <tr>  
                        <td>Inputer</td>
                        <td>:</td>
                        <td><input type="text" name="inputer" id="inputer"required value="<?= $lgn["inputer"];?>" /></td>
                    </tr>
        </table> 
