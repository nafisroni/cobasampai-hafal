...
<div class="container px-5 my-5">
      ...
      <table class="table table-warning table-hover" cellpadding="10" cellspacing="0">
                ...
                <tr>  
                    <td>Harga Billing</td>
                    <td>:</td>
                    <td><input type="text" name="hargabilling" id="hargabilling" class="form-control" /></td>
                </tr>
                <tr>  
                    <td>Durasi Billing</td>
                    <td>:</td>
                    <td><input type="time" name="durasibilling" id="durasibilling" class="form-control" /></td>
                </tr>
    </table> 
