...
<div class="container px-5 my-5">
        <div class="d-flex justify-content-md-center flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
            <h1 class="h2">Tambah Data PC Warnet</h1>
        </div>
      <table class="table table-warning table-hover" cellpadding="10" cellspacing="0">
                <tr>
                    <td width="20%">Jenis PC</td>
                    <td width="30px">:</td>
                    <td><input type="text" name="jenispc" id="jenispc" class="form-control" /></td>
                </tr>
                <tr>  
                    <td>spesifikasi</td>
                    <td>:</td>
                    <td><input type="text" name="spek" id="spek" class="form-control" /></td>
                </tr>
    </table> 
