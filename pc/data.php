<?php 
  ...
  $tb_pc = query("SELECT * FROM tb_pc ORDER BY jenispc");

  // tombol cari di klik
  if(isset($_POST["cari"])) {
    $tb_pc = cariini($_POST ["keyword"]);
  }
?>
            ...
            <div class="d-flex flex-column flex-shrink-0 p-3 text-white" style="height: auto; width: 280px">
              ...
              <ul class="nav nav-pills flex-column mb-auto">
                ...
                <li class="text-start nav-item">
                  <a href="../pc/data.php" class="nav-link active bg-light text-dark mb-4">
                    Data PC
                  </a>
                </li>
                <li class="text-start nav-item">
